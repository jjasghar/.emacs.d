...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode notmuch wanderlust web-mode git-gutter zenburn-theme gist markdown-mode markdown-mode+ org-bullets yasnippet try solarized-theme powerline magit-gh-pulls magit-gerrit helm guide-key flycheck company)))
